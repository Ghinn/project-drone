...
exports.sendAdminInvitationEmail = exports.sendResetPasswordEmail = exports.sendVerificationEmail = void 0;
...
const sendAdminInvitationEmail = async (to, token, name) => {
    const clientUrl = process.env.CLIENT_URL || 'http://localhost:3000';
